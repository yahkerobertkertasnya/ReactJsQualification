...
function DetailsFavoriteButton({ id } : { id : number} ){
    ...
    return(
        <button className="btn m-0 p-0 my-1 shadow-none btn-link" onClick={() => { setFavorite(!isFavorite) }}>
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill={ isFavorite ? "red" : "white" } className="bi bi-heart-fill" viewBox="0 0 16 16">
