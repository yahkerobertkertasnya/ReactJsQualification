...
function FavoriteButton({id} : {id : number}){
    ...
    return(
        <button className="btn p-0 mb-4 shadow-none btn-link" onClick={() => { setFavorite(!isFavorite) }}>
            <svg xmlns="http://www.w3.org/2000/svg" width="4vw" height="4vw" fill={ isFavorite ? "red" : "white" } className="bi bi-heart-fill" viewBox="0 0 16 16">
